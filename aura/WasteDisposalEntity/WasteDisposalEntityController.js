({
    ...
    handleFacilityChange : function(component, event, helper) {
        var record = event.getParam("record");
        if (record) {
            component.set("v.data.Facility__c", record.Id);
            component.set("v.data.FacilityName", record.Name);
        }
        else {
            component.set("v.data.Facility__c", null);
            component.set("v.data.FacilityName", null);
        }
    },
