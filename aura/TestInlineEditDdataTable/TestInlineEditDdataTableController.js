        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (visible == true) {
                ...
                if (mapRowComponentsByRowIndex.has(i)) {
                    ...
                    var checkbox = rowComponent.find(fieldName);
                    if (checkbox) {
                        checkbox.set("v.checked", checked);
                    }
                    rowComponent.set("v." + varName + "." + fieldName, checked);
                }
                ...
                if (inlineEditComponent) {
                    ...
                    if (rowIndex == i) {
                        ...
                        var checkbox = inlineEditComponent.find(fieldName);
                        if (checkbox) {
                            checkbox.set("v.checked", checked);
                        }
                        inlineEditComponent.set("v." + varName + ".[" + fieldName + "]", checked);
                    }
                }
            }
        }
