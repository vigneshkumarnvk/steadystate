({
    search : function(component, event, keyword, callback) {
        ...
        if (useStaticOption) {
            ...
            component.set("v.showLookupSpinner", true);
            if(pageName){
                var parentRecord = component.get("v.relatedRecordId");
				var params1 = {
                "sObjectName": sObjectName,
                "fields": fields,
                "fieldsToSearch": fieldsToSearch,
                ...
                "parentId": parentRecord
                 ...
                 this.callServerMethod(component, event, "c.getRecords", params1, function (records) {
    ...
    addLookupRecord : function(component, event, record) {
        ...
        if (records == null) {
         ...
         var recordExists = records.some(function(existingRecord) {
