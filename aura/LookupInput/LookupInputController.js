({
    ...
    handleLookupContainerBlur : function(component, event, helper) {
        ...
        //console.log("handleLookupContainerBlur")
    ...
    handleInputBoxClick : function(component, event, helper) {
        ...
        if (disabled != true) {
            ...
            //if (showLookupSpinner != true) {
            /*
            console.log(
                ((!lastClickedOn || (Date.now() - lastClickedOn > 100)) && showLookupSpinner != true) + ': ' + (!lastClickedOn) + ' , ' + (Date.now() - lastClickedOn > 100) + ' , ' + showLookupSpinner
            );*/
            
            if ((!lastClickedOn || (Date.now() - lastClickedOn > 100)) && showLookupSpinner != true) {
                var keyword = component.get("v.keyword");
                //var xKeyword = component.get("v.xKeyword");
                //if (xKeyword != keyword) {
    ...
    handleInputBoxFocus : function(component, event, helper) {
        //component.set("v.cursorInInputBox", true);
        //console.log("set cursorInInputBox = true")
    },
    handleInputBoxBlur : function(component, event, helper) {
        ...
        //debug <<
        //if ($A.get("$SObjectType.CurrentUser.Email") == 'kchen@micro-datanet.com') {
        //    return;;
        //}
        //debug >>
        
        //component.set("v.cursorInInputBox", false);
        
        //var mouseOverDropdown = component.get("v.mouseOverDropdown");
        //console.log("mouseOverDropdown = " + mouseOverDropdown)
        //if (mouseOverDropdown != true) {
        helper.closeDropdown(component, event);
        //}
    },
